...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleEntityNotFoundException(EntityNotFoundException ex, WebRequest request) {
        ApiError error = new ApiError(request.getDescription(false), ex.getMessage(),
    ...
    public ResponseEntity<ApiError> handleValidationException(MethodArgumentNotValidException ex, WebRequest request) {
        ...
        ApiError error = new ApiError(request.getDescription(false), message, HttpStatus.BAD_REQUEST.value(), LocalDateTime.now());
    ...
    public ResponseEntity<ApiError> handleGlobalException(Exception ex, WebRequest request) {
        ApiError error = new ApiError(request.getDescription(false),
